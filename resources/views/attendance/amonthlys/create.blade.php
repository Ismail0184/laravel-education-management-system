...
@section('content')
 ...
 <div class="container-fluid">
        ...
        <div class="card-body">
            {!! Form::open(array('route' => 'amonthlys.store','method'=>'POST')) !!}
                    ...
                    <div class="col-lg-6">
                        <div class="form-group {{ $errors->has('presence') ? ' has-danger' : '' }}">
                            ...
                            <div class="input-group-prepend">
                                ...
                                <input class="form-control {{ $errors->has('presence') ? ' is-invalid' : '' }}" placeholder="{{ __('lang.presence') }}" type="text" name="presence" value="{{ '26' }}" required>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group {{ $errors->has('absence') ? ' has-danger' : '' }}">
                            ...
                            <div class="input-group-prepend">
                                ...
                                <input class="form-control {{ $errors->has('absence') ? ' is-invalid' : '' }}" placeholder="{{ __('lang.absence') }}" type="text" name="absence" value="{{ '00' }}" required>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group {{ $errors->has('leave') ? ' has-danger' : '' }}">
                            <div class="input-group input-group mb-3">
                                ...
                                <input class="form-control {{ $errors->has('leave') ? ' is-invalid' : '' }}" placeholder="{{ __('lang.leave') }}" value="{{ '00' }}" type="text" name="leave">
                            </div>
                            @if ($errors->has('leave'))
                                <span class="invalid-feedback" style="display: block;" role="alert">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group {{ $errors->has('weekend') ? ' has-danger' : '' }}">
                            ...
                            <div class="input-group-prepend">
                                ...
                                <input class="form-control {{ $errors->has('weekend') ? ' is-invalid' : '' }}" placeholder="{{ __('lang.weekend') }}" type="text" name="weekend" value="{{ '00' }}" required>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group {{ $errors->has('holiday') ? ' has-danger' : '' }}">
                            <div class="input-group input-group mb-3">
                                ...
                                <input class="form-control {{ $errors->has('holiday') ? ' is-invalid' : '' }}" placeholder="{{ __('lang.holiday') }}" value="{{ '00' }}" type="text" name="holiday">
                            </div>
