...
<div class="row justify-content-center pt-5">
    <div class="col-lg-11">
        <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('groups.index') }}" class="btn btn-sm btn-neutral">{{ __('lang.refresh') }}</a>
            <a href="{{ route('groups.create') }}" class="btn btn-sm btn-neutral">{{ __('lang.addnew') }}</a>
            <a href="{{ route('groups.report') }}" class="btn btn-sm btn-neutral">{{ __('lang.report') }}</a>
        </div>
    @if (count($errors) > 0)
            ...
            <table class="table align-items-center table-flush">
                <thead class="thead-light">
                    <tr >
                        ...
                        <th scope="col" class="text-orange w-50">{{ __('lang.group') }}</th>
                        <th scope="col" class="text-blue w-10">{{ __('lang.maingroup') }}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="font-weight-bold text-blue">{{ $data->maingroup }}</td>
                        ...
                        <td class="text-right">
                            <a href="{{ route('groups.show', $data->id) }}" title="show">
                                <i class="fas fa-eye text-orange  fa-lg"></i>
                            </a>
                           <a href="{{ route('groups.edit', $data->id) }}">
                                <i class="fa fas fa-edit  fa-lg"></i>

                            </a>
                            <a data-toggle="modal" id="smallButton" data-target="#smallModal" data-attr="{{ route('groups.delete', $data->id) }}" title="Delete Project">
