...
<div class="row justify-content-center">
    ...
    <div class="card shadow">
        <h3 class="ribbon"> হিসাবের তালিকা </h3>
    <div class="table-responsive">
            <table class="table align-items-center table-flush">
                <thead class="thead-light">
                    <tr >
                        <th scope="col" class="text-blue w-10">{{ __('lang.id') }}</th>
                        <th scope="col" class="text-orange w-60">{{ __('lang.ahead') }}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="font-weight-bold text-orange">{{ $data->group->name }}</td>
                        <td class="font-weight-bold text-orange">{{ $data->group->maingroup }}</td>
