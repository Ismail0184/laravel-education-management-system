...
<div class="row justify-content-center pt-3">
    <div class="col-lg-11">
        <h6 class="mb-2 text-success">{{ __('lang.createdistrict')}}</h6>
        <div class="col-lg-11 text-center">
            <a href="{{ route('districts.create') }}" class="btn btn-sm btn-neutral">{{ __('lang.addnew') }}</a>
            <a href="{{ route('districts.report') }}" class="btn btn-sm btn-neutral">{{ __('lang.report') }}</a>
            ...
            <table class="table align-items-center table-flush">
                <thead class="thead-light">
                    <tr >
                        ...
                        <th scope="col" class="text-orange w-50">{{ __('lang.district') }}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="font-weight-bold text-blue"><a class="text-decoration-none" href="{{ url('division',$data->division) }}">{{ $data->division }}</a></td>
                        ...
                        <td class="text-right">
                            <a href="{{ route('districts.show', $data->id) }}" title="show">
                           ...
                           <a href="{{ route('districts.edit', $data->id) }}">
                            ...
                            <a data-toggle="modal" id="smallButton" data-target="#smallModal" data-attr="{{ route('districts.delete', $data->id) }}" title="Delete Project">
