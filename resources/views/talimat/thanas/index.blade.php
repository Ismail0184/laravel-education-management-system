...
<div class="row justify-content-center pt-3">
    <div class="col-lg-11">
        <h6 class="mb-2 text-success">{{ __('lang.createthana')}}</h6>
        <div class="col-lg-11 text-center">
            <a href="{{ route('thanas.create') }}" class="btn btn-sm btn-neutral">{{ __('lang.addnew') }}</a>
            <a href="{{ route('thanas.report') }}" class="btn btn-sm btn-neutral">{{ __('lang.report') }}</a>
            ...
            <table class="table align-items-center table-flush">
                <thead class="thead-light">
                    <tr >
                        ...
                        <th scope="col" class="text-orange w-40">{{ __('lang.thana') }}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="font-weight-bold text-blue"><a class="text-decoration-none" href="{{ url('district',$data->district_id) }}">{{ $data->district ? $data->district->name : ''}}</a></td>
                        ...
                        <td class="text-right">
                            <a href="{{ route('thanas.show', $data->id) }}" title="show">
                                <i class="fas fa-eye text-orange  fa-lg"></i>
                            </a>
                           <a href="{{ route('thanas.edit', $data->id) }}">
                                <i class="fa fas fa-edit  fa-lg"></i>

                            </a>
                            <a data-toggle="modal" id="smallButton" data-target="#smallModal" data-attr="{{ route('thanas.delete', $data->id) }}" title="Delete Project">
