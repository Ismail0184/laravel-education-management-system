...
<div class="container pb-5">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
              <a href="{{ route('results.index') }}" class="btn btn-sm btn-neutral">{{ __('lang.back') }}</a>
              <a href="{{ url('refresh') }}" class="btn btn-sm btn-neutral">{{ __('lang.refreshMemory') }}</a>
        </div>
                                ...
                                <div class="form-group {{ $errors->has('student_id') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control" name="student_id" data-toggle="select">
                                        ...
                                        @foreach ($students as $key => $value)
                                                <option value="{{ $key }}" {{ ( $key == $a_id) ? 'selected' : '' }}> 
                                                    {{ $value }} 
                                                </option>
                                            @endforeach    
                                        </select>
