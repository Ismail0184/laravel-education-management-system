...
<div class="row justify-content-center pt-3">
    <div class="col-lg-11">
        <h6 class="mb-2 text-success">{{ __('lang.whichdaypart')}}</h6>
        <div class="col-lg-11 text-center">
            <a href="{{ route('dayparts.index') }}" class="btn btn-sm btn-neutral">{{ __('lang.refresh') }}</a>
            <a href="{{ route('dayparts.create') }}" class="btn btn-sm btn-neutral">{{ __('lang.addnew') }}</a>
            <a href="{{ route('dayparts.report') }}" class="btn btn-sm btn-neutral">{{ __('lang.report') }}</a>
        </div>
    @if (count($errors) > 0)
            ...
            <table class="table align-items-center table-flush">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{ route('dayparts.show', $data->id) }}" title="show">
                                <i class="fas fa-eye text-orange  fa-lg"></i>
                            </a>
                           <a href="{{ route('dayparts.edit', $data->id) }}">
                                <i class="fa fas fa-edit  fa-lg"></i>

                            </a>
                            <a data-toggle="modal" id="smallButton" data-target="#smallModal" data-attr="{{ route('dayparts.delete', $data->id) }}" title="Delete Project">
