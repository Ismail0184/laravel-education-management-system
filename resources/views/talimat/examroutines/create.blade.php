            ...
            <div class="col-lg-6 col-md-8">
                <div class="card bg-light shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        {!! Form::open(array('route' => 'examroutines.store','method'=>'POST')) !!}
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group {{ $errors->has('exam_date') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input class="form-control datepicker {{ $errors->has('exam_date') ? ' is-invalid' : '' }}" data-date-format="yyyy-mm-dd" placeholder="{{ __('lang.exam_date') }}" value="{{ date('Y-m-d') }}" type="text" name="exam_date" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group {{ $errors->has('daypart_id') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control" name="daypart_id" data-toggle="select" required>
                                        ...
                                        @foreach ($dayparts as $key => $value)
                                                <option value="{{ $key }}" {{ ( $key == $dp_id) ? 'selected' : '' }}> 
                                                    {{ $value }} 
                                                </option>
                                            @endforeach    
                                        </select>
