    ...
    <div class="col-lg-8 margin-tb">
        <div class="card shadow">
            <div class="card shadow">
                ...
                <hr class="my-4" />
                        <form method="post" action="{{route('admissions.fileUpload')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group {{ $errors->has('classes_id') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control" name="image_field" data-toggle="select" required>
                                        ...
                                        <option value='birth_image_name'>{{ __('lang.birth_image_name') }}</option>
                                        </select>
                                    </div>
                ...
                <table class="table table-responsive{-sm|-md|-lg|-xl} align-items-center table-flush">
                    ...
                    <tr class="row m-0">
                        ...
                        <td class="d-inline-block col-5" colspan=4>
                            <img src="{{ asset('students') }}/{{ $data->profile_image_name }}" class="img-thumbnail rounded-circle">
                        </td>
                    </tr>
                    <tr class="row m-0">
