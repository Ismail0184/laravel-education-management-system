...
<div class="row justify-content-center pt-5">
    <div class="col-lg-11">
        <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('branches.index') }}" class="btn btn-sm btn-neutral">{{ __('lang.refresh') }}</a>
            <a href="{{ route('branches.create') }}" class="btn btn-sm btn-neutral">{{ __('lang.addnew') }}</a>
            <a href="{{ route('branches.report') }}" class="btn btn-sm btn-neutral">{{ __('lang.report') }}</a>
        </div>
    @if (count($errors) > 0)
            ...
            <table class="table align-items-center table-flush">
                <thead class="thead-light">
                    <tr >
                        ...
                        <th scope="col" class="text-orange w-30">{{ __('lang.branch') }}</th>
                        <th scope="col" class="text-blue w-20">{{ __('lang.class') }}</th>
                        <th scope="col" class="text-blue w-20">{{ __('lang.createdBy') }}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{ route('branches.show', $data->id) }}" title="show">
                           ...
                           <a href="{{ route('branches.edit', $data->id) }}">
                            ...
                            <a data-toggle="modal" id="smallButton" data-target="#smallModal" data-attr="{{ route('branches.delete', $data->id) }}" title="Delete Project">
