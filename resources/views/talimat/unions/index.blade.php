...
<div class="row justify-content-center pt-3">
    <div class="col-lg-11">
        <h6 class="mb-2 text-success">{{ __('lang.createunion')}}</h6>
        <div class="col-lg-11 text-center">
            <a href="{{ route('unions.index') }}" class="btn btn-sm btn-neutral">{{ __('lang.refresh') }}</a>
            <a href="{{ route('unions.create') }}" class="btn btn-sm btn-neutral">{{ __('lang.addnew') }}</a>
            <a href="{{ route('unions.report') }}" class="btn btn-sm btn-neutral">{{ __('lang.report') }}</a>
        </div>
    @if (count($errors) > 0)
            ...
            <table class="table align-items-center table-flush">
                <thead class="thead-light">
                    <tr >
                        ...
                        <th scope="col" class="text-orange w-40">{{ __('lang.union') }}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="font-weight-bold text-blue">{{ $data->thana ? $data->thana->district->name : '' }}</td>
                        ...
                        <td class="text-right">
                            <a href="{{ route('unions.show', $data->id) }}" title="show">
                                <i class="fas fa-eye text-orange  fa-lg"></i>
                            </a>
                           <a href="{{ route('unions.edit', $data->id) }}">
                                <i class="fa fas fa-edit  fa-lg"></i>

                            </a>
                            <a data-toggle="modal" id="smallButton" data-target="#smallModal" data-attr="{{ route('unions.delete', $data->id) }}" title="Delete Project">
