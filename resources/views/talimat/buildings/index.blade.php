...
<div class="row justify-content-center pt-3">
    <div class="col-lg-11"> 
        <h6 class="mb-2 text-success">{{ __('lang.createbuilding')}}</h6>
        <div class="col-lg-11 text-center">
            <a href="{{ route('buildings.index') }}" class="btn btn-sm btn-neutral">{{ __('lang.refresh') }}</a>
            <a href="{{ route('buildings.create') }}" class="btn btn-sm btn-neutral">{{ __('lang.addnew') }}</a>
            <a href="{{ route('buildings.report') }}" class="btn btn-sm btn-neutral">{{ __('lang.report') }}</a>
        </div>
    @if (count($errors) > 0)
            ...
            <table class="table align-items-center table-flush">
                ...
                <tbody>
                    ...
                    <td class="font-weight-bold text-blue text-center">{{ \App\Http\Controllers\BnumberController::toBangla(++$i) }}</td> 
                        ...
                        <td class="text-right">
                            <a href="{{ route('buildings.show', $data->id) }}" title="show">
                           ...
                           <a href="{{ route('buildings.edit', $data->id) }}">
                            ...
                            <a data-toggle="modal" id="smallButton" data-target="#smallModal" data-attr="{{ route('buildings.delete', $data->id) }}" title="Delete Project">
