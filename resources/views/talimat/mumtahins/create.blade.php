            ...
            <div class="col-lg-6 col-md-8">
                <div class="card bg-light shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        {!! Form::open(array('route' => 'mumtahins.store','method'=>'POST')) !!}
                        <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group {{ $errors->has('last_date') ? ' has-danger' : '' }}">
                                    <div class="input-group input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fa fa-birthday-cake text-orange"></i></span>
                                    </div>
                                        <input class="form-control datepicker {{ $errors->has('last_date') ? ' is-invalid' : '' }}" data-date-format="yyyy-mm-dd" placeholder="{{ __('lang.exam_date') }}" value="{{ date('Y-m-d') }}" type="text" name="last_date" required>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                <button type="submit" class="btn btn-primary">{{ __('lang.submit') }}s</button>
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
