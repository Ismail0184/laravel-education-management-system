...
<div class="row justify-content-center">
    ...
    <div class="card shadow">
        <h3 class="ribbon"> ভবনের কক্ষ তালিকা </h3>
    <div class="table-responsive">
            <table class="table align-items-center table-flush">
                <thead class="thead-light">
                    <tr >
                        <th scope="col" class="text-blue w-10">{{ __('lang.id') }}</th>
                        <th scope="col" class="text-orange w-50">{{ __('lang.room') }}</th>
                        <th scope="col" class="text-orange w-10">{{ __('lang.building') }}</th>
                ...
                <tbody>
                    ...
                    <td class="font-weight-bold text-blue text-center">{{ \App\Http\Controllers\BnumberController::toBangla(++$i) }}</td> 
                        ...
                        <td class="font-weight-bold text-orange">{{ $data->building->name }}</td>
